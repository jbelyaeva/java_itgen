...
public class ChatCorrectMessageTest extends TestBase {
  ...
  public void ensurePreconditions() {
    ...
    app.trChat().saveChatMessage("modifyMessage","RoomModifyMessage", new Date(), messageOld,"666");
  ...
  public void testChatCorrectMessage() {
    ...
    app.chat().modifyMessage("23",messageNew);
