  ...
  public void ensurePreconditions() {
    ...
    ScheduleData schedule = new ScheduleData()
            ...
            .withSlots(Arrays.asList(new Slots()
                    ...
                    .withC(Arrays.asList(new C().withId("SshotOnLessonWithStudent").withType(1).withSubject("1")
    ...
    StudentData student = new StudentData().withId("SshotOnLessonWithStudent").withFirstName("Маша").withLastName("Машина")
            .withRoles(Arrays.asList("child"))
            .withPclevel("expert").withCountry("AL").withTimeZone("Europe/Minsk").withGender(2)
            .withFamilyId("SshotOnLessonWithStudent").withStudyLang("ru").withLocate("ru")
