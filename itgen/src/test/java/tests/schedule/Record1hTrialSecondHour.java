 ...
 * Записать на пробное на второй час
...
public class Record1hTrialSecondHour extends TestBase {
  ...
  public void testRecord1hTrialSecondHour() {
    String name = "Машина Маша";
    app.goTo().menuSchedule();
    app.schedule().recordStudentOnTrialSecond1h(name, "newSchedule");
    ...
    //проверяем, что запись на второй час
