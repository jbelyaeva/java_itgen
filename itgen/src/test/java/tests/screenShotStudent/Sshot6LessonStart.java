...
public class Sshot6LessonStart extends TestBase {
  ...
  @Test
  public void testSshot6LessonStart() throws AWTException, IOException {
    String name = "Student_LessonStart_RU_Chrome";
    app.student().goToLesson();
    app.student().deleteAlerts();

    Set<By> locatorIgnor = new HashSet<>();
    locatorIgnor.add(By.xpath("//div[@class='text-capitalize']"));
