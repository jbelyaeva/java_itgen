...
public class GeneralPageTransitionFromCalendarToSchedule extends TestBase {
  ...
  public void testGeneralPageTransitionFromCalendarToSchedule() {
    ...
    app.check().findElement(app.lkParent().tabSchedule());
    app.check().textElement(app.lkParent().schedulePeriodLesson(), period);
    app.check().textElement(app.lkParent().scheduleTrainerOnLesson(),
        trainer.getLastName() + " " + trainer.getFirstName());
    app.check().textElement(app.lkParent().scheduleSkillOnLesson(), "Scratch");
    app.check().findElement(app.lkParent().scheduleLabelNewOnLesson());
    app.check().findElement(app.lkParent().scheduleLabelPlannedOnLesson());
