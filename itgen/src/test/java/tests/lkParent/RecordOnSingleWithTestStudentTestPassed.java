 ...
 * на направление. У ребенка есть пройденный тест на направление майнкрафт. На завтра ест
...
public class RecordOnSingleWithTestStudentTestPassed extends TestBase {
