 ...
 * занятия из постоянного расписания через чек-бокс
 */
...
public class CancelOnRegularInCheckBox extends TestBase {
  ...
  public void testCancelOnRegularInCheckBox() {
    app.lkParent().btnLogo();
    Schedules before = app.dbschedules().schedules();
    app.lkParentRecord().cancelLessonsInRegularScheduleByCheckBox();
