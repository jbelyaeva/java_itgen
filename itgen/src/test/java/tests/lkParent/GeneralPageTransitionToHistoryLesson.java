...
public class GeneralPageTransitionToHistoryLesson extends TestBase {
  ...
  public void testGeneralPageTransitionToHistoryLesson() {
    ...
    app.check().findElement(app.lkParent().tabHistory());
    app.check().textElement(app.lkParent().labelPeriodLessonInHistory(), period);
    String day = formatDD(app.base().DateWithCorrectionDays(-1));
    app.check().textElement(app.lkParent().labelDayAndMonthLessonInHistory(), day);
    app.check().textElement(app.lkParent().labelProjectDoneInHistory(), "Лабиринт");
    app.check().textElement(app.lkParent().labelProjectNotStartedInHistory(), "Жуки");
    app.check().findElement(app.lkParent().labelGradeAboutLessonInHistory());
