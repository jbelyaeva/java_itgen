...
public class AdminCommunityTabFeedDeleteAndModifyPost extends TestBase {
  ...
  public void testAdminCommunityTabFeedDeleteAndModifyPost() {
    ...
    app.student().tabFeed();
    app.check().findElement(By.xpath("//div[@class='right']//button"));
    app.student().btnPoint();
    app.check().findElement(By.xpath("//span[@id-qa='menu-edit']"));
    app.check().findElement(By.xpath("//span[@id-qa='menu-delete']"));
  }
