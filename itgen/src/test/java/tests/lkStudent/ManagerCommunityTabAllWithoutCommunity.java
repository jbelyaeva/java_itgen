...
/**
 * Начальные данные: дефолтный ребенок c подпиской на сообщество, имеет права на создание
 * сообщества, и правом менеджера (сделать админом) Перейти в Сообщества и проверить, что в табе Все
 * сообщество пропало и появилось в табе Управление. Есть кнопки удалить/изменить пост
 */
