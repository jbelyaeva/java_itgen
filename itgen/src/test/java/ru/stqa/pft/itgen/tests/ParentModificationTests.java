...
public class ParentModificationTests extends TestBase {
  ...
  public void testParentModification() {
    ...
    app.getStudentHelper().ModifyParentForm(new ParentData("Вова", "Ласточкин", "Венгрия", "Высоково", "(GMT-10:00) Тихий океан/Гонолулу", "Английский", "84958887856", "домик", null, "ггггггг", "89995632129", "74965477823", "telega", "бук", "контакт", "одноклассники", "стаг", "444ггггг", "кккккккк"));
