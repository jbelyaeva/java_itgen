...
import data.model.materials.New;
...
public class TrMaterialHelper {
  ...
  public void newMaterial(
    ...
    MaterialData material =
        materialBase(idMaterial, creator, title, status, skill, idBranch, type, level, lang)
            ...
            .withTags(tags)
            .withLinkedMaterials(linkedMaterials)
  ...
  public void publishedMaterial( //+доработка
      String idMaterial,
      String creator,
      String title,
      String status,
            ...
            .withActivity(
                Arrays.asList(
                    ...
                    new Activity()
                        ...
                        .withTs(new Date())
                        .withT("statusChanged")
                        .withD(new D().withNewData("rework").withOldData("checking"))))
            .withVerifier(verifier);
    materialService.save(material);
  }
  ...
  public void materialNew(String idUser) {
    MaterialNewData newMaterial = new MaterialNewData()
        .withId("newMaterial")
        .withTrainerId(idUser)
        .withNewMaterials(new New().withNewMaterials(Arrays.asList("material")));
    materialNewService.save(newMaterial);
  }

  public void checkingMaterialWithComment(
      String idMaterial,
      String creator,
      String title,
      String status,
    ...
    MaterialData material =
        materialBase(idMaterial, creator, title, status, skill, idBranch, type, level, lang)
            ...
            .withComments(
                Arrays.asList(
                    new Comments().withId("different")
                        .withOwner(ownerComment)
                        .withText("Комментарий")
                        .withCreateAt(new Date())))
            .withDesc(desc)
            .withActivity(
                Arrays.asList(
                    ...
                    new Activity()
                        ...
                        .withTs(new Date())
                        .withT("commentAdded")
                        .withD(new D().withNewData(text).withCId("different").withLangs(null))))
            .withVerifier(verifier);
    materialService.save(material);
  }
}
